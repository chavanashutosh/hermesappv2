...
describe("Registration", function () {
    ...
    it("should show server picker when custom URLs are allowed", async function () {
        SdkConfig.put({ ...DEFAULTS, disable_custom_urls: false });
        const { container } = getComponent();
        expect(container.querySelector(".mx_ServerPicker")).toBeTruthy();
    });

    it("should hide server picker when custom URLs are disabled", async function () {
        const { container } = getComponent();
